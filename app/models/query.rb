class Query < ApplicationRecord
    #Table Design
    #| headphone_type | bluetooth_weighting | battery_weighting | noise_cancelling_weighting | base_weighting | max_price |
    ...
    validates :battery_weighting, presence: true, numericality: {only_integer: true , greater_than_or_equal_to: 0 , less_than_or_equal_to: 5 }
